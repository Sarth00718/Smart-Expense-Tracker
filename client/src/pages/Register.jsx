              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative group">
                    <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 ${fieldErrors.fullName ? 'text-red-500' : focusedField === 'fullName' ? 'text-primary-500 scale-110' : formData.fullName ? 'text-primary-500' : 'text-gray-400'
                      }`} />
                    <input
                      type="text"
                      id="fullName"
                ...
                <div>
                  ...
                  <div className="relative group">
                    <Mail className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 ${fieldErrors.email ? 'text-red-500' : focusedField === 'email' ? 'text-primary-500 scale-110' : formData.email ? 'text-primary-500' : 'text-gray-400'
                      }`} />
                    <input
                      type="email"
                      id="email"
                ...
                <div>
                  ...
                  <div className="relative group">
                    <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 ${fieldErrors.password ? 'text-red-500' : focusedField === 'password' ? 'text-primary-500 scale-110' : formData.password ? 'text-primary-500' : 'text-gray-400'
                      }`} />
                    <input
                    ...
                    <div className="mt-3">
                      <div className="flex gap-1.5 mb-2">
                        {[1, 2, 3, 4].map((level) => (
                          <div
                            key={level}
                            className={`h-2 flex-1 rounded-full transition-all duration-300 ${level <= passwordStrength ? getPasswordStrengthColor() : 'bg-gray-200'
                              }`}
                          ></div>
                        ))}
                      </div>
                      {getPasswordStrengthText() && (
                        <p className="text-xs text-gray-600 font-medium tracking-tight">
                          Password strength: <span className={`font-semibold ${passwordStrength <= 2 ? 'text-red-600' : passwordStrength === 3 ? 'text-yellow-600' : 'text-green-600'
                ...
                <div>
                  ...
                  <div className="relative group">
                    <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 ${fieldErrors.confirmPassword ? 'text-red-500' : focusedField === 'confirmPassword' ? 'text-primary-500 scale-110' : formData.confirmPassword ? 'text-primary-500' : 'text-gray-400'
                      }`} />
                    <input

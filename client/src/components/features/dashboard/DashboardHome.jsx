            ...
            {recentExpenses.length > 0 ? (
              <div className="space-y-3">
                {recentExpenses.map((expense) => (
                  <div 
                    key={expense._id}
                    className="flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-primary hover:shadow-sm transition-all cursor-pointer"
                    onClick={() => navigate('/dashboard/expenses')}
                  >
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-gray-900">Budgets</span>
                </div>
                <ArrowUpRight className="w-4 h-4 text-gray-400 group-hover:text-primary" />
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-gray-900">Heatmap</span>
                </div>
                <ArrowUpRight className="w-4 h-4 text-gray-400 group-hover:text-primary" />
              </button>
            </div>
